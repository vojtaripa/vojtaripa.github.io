...
//https://support.autopilothq.com/hc/en-us/articles/204955206-Download-sample-HTML-email-templates
		$message="
					...
					<body bgcolor='#FFFFFF'>
					  ...
					  'background-color: #FFFFFF' width='100%'>
						...
						<![endif]-->
							...
							<h1><strong>A new user: $myusername signed up<br> for Finishline. <i class='icon fa-flag-checkered'></i></strong></h1>
		...
		$subject = "test"; //Finishline: New user $myusername
		...
		header("Location:http://vojta.users.sonic.net/DevNull/Template1/pages/RaceResults.php?choice=search&user=vojtaripa&password=aa729258764c01f0436786c83fd1c6ff17efcfaf&Year=2004&Distance=#Filters");
?>
